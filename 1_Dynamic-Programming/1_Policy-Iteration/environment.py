...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open("../../envs_info/grid-world/up.png").resize((13, 13)))
        right = PhotoImage(Image.open("../../envs_info/grid-world/right.png").resize((13, 13)))
        left = PhotoImage(Image.open("../../envs_info/grid-world/left.png").resize((13, 13)))
        down = PhotoImage(Image.open("../../envs_info/grid-world/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open("../../envs_info/grid-world/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("../../envs_info/grid-world/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("../../envs_info/grid-world/circle.png").resize((65, 65)))
